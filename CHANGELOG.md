...
- **Company invite emails use shared helper** — Invite emails now go through `sendEmail()` for consistent bounce suppression, delivery tracking, and branded wrapping.
