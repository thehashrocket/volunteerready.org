...
export async function sendRosterAddedEmail(input: {
	...
	await sendEmail(
        ...
        <p>This means they can schedule you for shifts and record the hours you
           volunteer with them. You don't need to do anything.</p>
        <p>If this wasn't expected, you can leave their roster from
           <a href="${profileUrl}" style="color: #1B3C2A;">your profile</a>.</p>
    `,
	);
}
