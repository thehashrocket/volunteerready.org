...
| `src/server/repositories/orgVolunteerRepo.ts` | Roster reads + `findOrgVolunteerRelationship()` — the accepted-relationship set and the reasoning for what is deliberately excluded |
